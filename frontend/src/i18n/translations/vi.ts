...
export const vi: Record<TranslationKey, string> = {
  ...
  // Vocabulary Screen
  'vocabulary.title': 'Từ vựng của tôi',
  'vocabulary.count': 'từ',
  'vocabulary.reviewDue': 'Ôn từ đến hạn',
  'vocabulary.reviewAll': 'Ôn tất cả',
  'vocabulary.empty': 'Chưa có từ nào được lưu',
  'vocabulary.error': 'Không thể tải danh sách từ vựng.',
  'vocabulary.retry': 'Thử lại',
  'vocabulary.delete': 'Xóa',
  'vocabulary.deleteConfirmTitle': 'Xóa từ này?',
  'vocabulary.deleteConfirmBody': 'Xóa',
  'vocabulary.confirm': 'Xác nhận',
  'vocabulary.cancel': 'Hủy',
  'vocabulary.reveal': 'Hiện đáp án',
  'vocabulary.known': 'Đã biết ✓',
  'vocabulary.unknown': 'Chưa biết ✗',
  'vocabulary.exitReview': 'Thoát ôn tập',
  'vocabulary.reviewDone': 'Hoàn thành ôn tập',
  'vocabulary.reviewSummary': 'đã biết / chưa biết',
  'vocabulary.knownLabel': 'đã biết',
  'vocabulary.unknownLabel': 'chưa biết',
  'vocabulary.backToList': 'Về danh sách',
  'vocabulary.masteryNew': 'Mới',
  'vocabulary.masteryLearning': 'Đang học',
  'vocabulary.masteryHard': 'Khó',
  'vocabulary.masteryMastered': 'Thuộc',
  'nav.vocabulary': 'Từ vựng của tôi',
}
